...
const StockTransfer = () => {
  ...
  const handleTransfer = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch("https://pruebas-sap.onrender.com/stock-transfer", {
  method: "POST",
  headers: {
...
const removeLastItemLine = () => {
  ...
  setBatchDetails({ // Limpia los detalles del lote
   ...
   useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await fetch("https://pruebas-sap.onrender.com/items");
  ...
  const fetchBatchNumbers = async (itemCode) => {
    try {
      const response = await fetch(`https://pruebas-sap.onrender.com/inventario?codigo_item=${itemCode}&codigo_almacen=${origen}`);
  ...
  useEffect(() => {
    const fetchWarehouses = async () => {
      try {
        const response = await fetch("https://pruebas-sap.onrender.com/get-warehouses");
        const data = await response.json();
...
useEffect(() => {
  const fetchPriceLists = async () => {
    ...
    try {
      const response = await fetch(`https://pruebas-sap.onrender.com/business-partner-price-list/${cliente}`, { signal });
